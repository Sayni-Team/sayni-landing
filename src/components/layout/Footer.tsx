...
export default function Footer() {
    return (
        <footer className="w-full bg-[#111111] text-white pt-16 pb-12 px-6 sm:px-12 border-t border-white/10 font-sans">
            {/* Estilos para el efecto "tic / temblor" sutil en cascada */}
            <style jsx global>{`
                @keyframes letterTic {
                    0%, 85%, 100% {
            ...
            <div className="max-w-6xl mx-auto flex flex-col gap-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 text-center md:text-left items-start">
                    ...
                    <div className="md:col-span-5 flex flex-col gap-4 items-center md:items-start max-w-xs mx-auto md:mx-0">
                        <h3 className="font-clash text-2xl sm:text-3xl font-semibold leading-tight text-[#BCC90F]">
                            Una pausa que nace de nuestra tierra
                        </h3>
                        <p className="text-white/50 text-md sm:text-lg leading-relaxed">
              ...
              <span className="text-sm font-normal tracking-wider uppercase text-white/50">
                Explora
              </span>
              ...
              <span className="text-sm font-normal tracking-wider uppercase text-white/50">
                ...
                {/* BLOQUE CENTRAL: SVG con tamaño intermedio equilibrado */}
                <div className="flex justify-center items-center py-3.5">
                    <svg
                        ...
                        className="w-full max-w-[210px] sm:max-w-[280px] md:max-w-[330px] h-auto overflow-visible"
                    >
                        {/* Letra 'S' */}
                        <path
